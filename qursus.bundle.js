...
var _ApiService = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(_ApiService, [{
    ...
    key: "getUser",
    value: function () {
      var _getUser = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    ...
    key: "archive",
    value: function () {
      var _archive = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6(entity, ids) {
        var result, environment, params;
    ...
    key: "clone",
    value: function () {
      var _clone = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee8(entity, ids) {
        var result, environment, params;
    ...
    key: "search",
    value: function () {
      var _search = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee10(entity, domain, order, sort, start, limit) {
        var result, params, environment;
...
var ChapterClass = /*#__PURE__*/function () {
  function ChapterClass() {
    ...
    (0, _classCallCheck2.default)(this, ChapterClass);
  ...
  (0, _createClass2.default)(ChapterClass, [{
    ...
    value: function render(context) {
      ...
      if (this.pages && this.pages.length > this.context.page_index) {
        ...
        var page = new _Page.PageClass(item.id, item.identifier, item.order, item.leaves, item.type, item.next_active);
        ...
        */
                  ...
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    ...
                    for (var _i2 = 0, _Object$keys2 = Object.keys(_this); _i2 < _Object$keys2.length; _i2++) {
                      ...
                      if (object.hasOwnProperty(field)) {
                        _this[field] = _this[field] ? _this[field].constructor(object[field]) : object[field];
                      }
                    }
              ...
              if (data && data.objects) {
                ...
                try {
                  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                    ...
                    var _page = new _Page.PageClass(Number(_item.id), Number(_item.identifier), Number(_item.order), _item.leaves, _item.type, _item.next_active);
        ...
        $chapter_delete_button.on('click', function () {
          if (window.confirm("Chapter is about to be removed. Do you confirm ?")) {
            _qursusServices.ApiService.update('learn\\Module', [_this.parent.id], {
...
var _ContextService = /*#__PURE__*/function () {
  ...
  function _ContextService() {
    ...
    (0, _defineProperty2.default)(this, "chapter_index", 0);
 ...
 *
 */
var DomainClass = /*#__PURE__*/function () {
  function DomainClass(domain) {
    (0, _classCallCheck2.default)(this, DomainClass);
...
var GroupClass = /*#__PURE__*/function () {
  ...
  widgets, visible) // domain (ex. [ '$page.selection', '=', 2 ])
  {
    ...
    (0, _defineProperty2.default)(this, "row_span", void 0);
    (0, _defineProperty2.default)(this, "fixed", void 0);
    (0, _defineProperty2.default)(this, "widgets", void 0);
    (0, _defineProperty2.default)(this, "visible", void 0);
    (0, _defineProperty2.default)(this, "$container", void 0);
  ...
  (0, _createClass2.default)(GroupClass, [{
    ...
    value: function render(context) {
      ...
      group_classes += ' ' + direction; // handle horizontal widget layouts (depending on the number of widgets)
      ...
      for (var index in this.widgets) {
        ...
        var widget = new _Widget.WidgetClass(item.id, item.identifier, item.order, item.type, item.has_separator_left, item.has_separator_right, item.align, item.on_click, item.content, item.sound_url, item.video_url, item.image_url);
      ...
      if (context.mode == 'view') {
              ...
              if (data && data.objects) {
                ...
                try {
                  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                    ...
                    var _widget = new _Widget.WidgetClass(Number(_item.id), Number(_item.identifier), Number(_item.order), _item.type, _item.has_separator_left, _item.has_separator_right, _item.align, _item.on_click, _item.content, _item.sound_url, _item.video_url, _item.image_url);
        ...
        $delete_button.on('click', function () {
          if (window.confirm("Group is about to be removed. Do you confirm ?")) {
            _qursusServices.ApiService.delete('learn\\Group', [_this.id], true);
...
var LeafClass = /*#__PURE__*/function () {
  function LeafClass() //'light', 'dark' (text color)
  {
    ...
    (0, _defineProperty2.default)(this, "visible", void 0);
    (0, _defineProperty2.default)(this, "background_image", void 0);
    (0, _defineProperty2.default)(this, "background_opacity", void 0);
    (0, _defineProperty2.default)(this, "background_stretch", void 0);
    (0, _defineProperty2.default)(this, "contrast", void 0);
    (0, _defineProperty2.default)(this, "$container", void 0);
    (0, _defineProperty2.default)(this, "parent", void 0);
    (0, _defineProperty2.default)(this, "context", {
      actions_counter: 0,
          ...
          if (parts.length > 1) {
            if (parts[1] == 'actions_counter') {
              ...
              if (group_index > 0) {
                ...
                _qursusServices.ApiService.update('learn\\Group', [this.groups[group_index - 1].id], {
                  'order': this.groups[group_index].order
                }, true);

                _qursusServices.ApiService.update('learn\\Group', [this.groups[group_index].id], {
              ...
              if (_group_index < this.groups.length - 1) {
                ...
                _qursusServices.ApiService.update('learn\\Group', [this.groups[_group_index + 1].id], {
                  'order': this.groups[_group_index].order
                }, true);

                _qursusServices.ApiService.update('learn\\Group', [this.groups[_group_index].id], {
...
var ModuleClass = /*#__PURE__*/function () {
  function ModuleClass() {
    ...
    (0, _classCallCheck2.default)(this, ModuleClass);
    (0, _defineProperty2.default)(this, "id", void 0);
    (0, _defineProperty2.default)(this, "identifier", void 0);
    (0, _defineProperty2.default)(this, "order", void 0);
    (0, _defineProperty2.default)(this, "name", void 0);
    ...
    (0, _defineProperty2.default)(this, "chapters", void 0);
    (0, _defineProperty2.default)(this, "$container", void 0);
    (0, _defineProperty2.default)(this, "context", {
      actions_counter: 0,
      chapter_index: 0,
    ...
    value: function init() {
      ...
      if (this.context.mode == 'view') {
        ...
        */
        ...
        $module_edit_button.on('click', /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
          var environment;
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
...
var PageClass = /*#__PURE__*/function () {
  function PageClass() // domain
  {
    ...
    (0, _defineProperty2.default)(this, "next_active", void 0);
    (0, _defineProperty2.default)(this, "selection", void 0);
    (0, _defineProperty2.default)(this, "$container", void 0);
    (0, _defineProperty2.default)(this, "parent", void 0);
    (0, _defineProperty2.default)(this, "context", {
  ...
  (0, _createClass2.default)(PageClass, [{
    ...
    value: function render(context) {
      ...
      (0, _jqueryLib.$)('body').find('.section-container.viewport-container').remove(); // reset section-nav buttons (hide)
              ...
              if (data && data.objects) {
                ...
                try {
                  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                    ...
                    var _leaf = new _Leaf.LeafClass(Number(_item.id), Number(_item.identifier), Number(_item.order), _item.groups, _item.visible, _item.background_image, _item.background_opacity, _item.background_stretch, _item.contrast);
        ...
        if (elem.indexOf('$page') == 0) {
          ...
          if (parts.length > 1) {
            if (parts[1] == 'actions_counter') {
              ...
              // value is widget id
              var _iterator3 = _createForOfIteratorHelper(this.leaves.entries()),
                  _step3;
 ...
 *
 */
var TextRendererClass = /*#__PURE__*/function () {
 ...
 *
 */
var WidgetClass = /*#__PURE__*/function () {
  function WidgetClass(id, identifier, order, type, has_separator_left, has_separator_right, align, on_click, content, sound_url, video_url, image_url) {
    (0, _classCallCheck2.default)(this, WidgetClass);
    (0, _defineProperty2.default)(this, "id", void 0);
    (0, _defineProperty2.default)(this, "identifier", void 0);
    (0, _defineProperty2.default)(this, "order", void 0);
    (0, _defineProperty2.default)(this, "type", void 0);
    (0, _defineProperty2.default)(this, "has_separator_left", void 0);
    (0, _defineProperty2.default)(this, "has_separator_right", void 0);
    (0, _defineProperty2.default)(this, "align", void 0);
    (0, _defineProperty2.default)(this, "on_click", void 0);
    (0, _defineProperty2.default)(this, "content", void 0);
    (0, _defineProperty2.default)(this, "sound_url", void 0);
    (0, _defineProperty2.default)(this, "video_url", void 0);
    (0, _defineProperty2.default)(this, "image_url", void 0);
    (0, _defineProperty2.default)(this, "selected", void 0);
    (0, _defineProperty2.default)(this, "parent", null);
    (0, _defineProperty2.default)(this, "$container", void 0);
    (0, _defineProperty2.default)(this, "previously_selected", false);
    (0, _defineProperty2.default)(this, "context", {
      mode: 'view'
    });
    this.id = id;
      ...
      if (context.mode == 'edit') {
        ...
        $delete_button.on('click', function () {
          if (window.confirm("Widget is about to be removed. Do you confirm ?")) {
            _qursusServices.ApiService.delete('learn\\Widget', [_this.id], true);
