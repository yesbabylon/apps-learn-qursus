...
export class WidgetClass {
    ...
    */
    public has_separator_left: boolean;                    // (2px at the bottom left of widget)
    public has_separator_right: boolean;                   // (2px at the bottom right of widget)
    ...
    */
    ...
    private previously_selected: boolean = false;
